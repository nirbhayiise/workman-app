...
import com.np.onei.servicesapp.ui.QRScannerActivity;
...
public class MainActivity extends AppCompatActivity implements MakePayInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qrbtn=(ImageView) findViewById(R.id.qrbtn);
    ...
    @Override
    public void PaySuccess(String amount,String rid,String serviceCharges,String payStat) {
