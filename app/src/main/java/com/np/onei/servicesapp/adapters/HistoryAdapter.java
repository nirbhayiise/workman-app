...
public class HistoryAdapter extends RecyclerView
   ...
   Context cntext;
    ...
    public HistoryAdapter(Context cnt, ArrayList<CategoryModel> myDataset) {
        mDataset = myDataset;
        cntext=cnt;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        sonictonicfonts = Typeface.createFromAsset(cntext.getAssets(), "fonts/avenir-light.ttf");
     //   holder.label.setText(mDataset.get(position).getmText1());
       ...
       //holder.dateTime.setTypeface(sonictonicfonts);
        /*Picasso.with(cntext)
                ...
                .placeholder(R.drawable.logodemo) //this is optional the image to display while the url image is downloading
                .error(R.drawable.logodemo)         //this is also optional if some error has occurred in downloading the image this image would be displayed
                .into(holder.imgct);*/
