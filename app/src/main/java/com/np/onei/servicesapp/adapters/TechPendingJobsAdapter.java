...
import com.np.onei.servicesapp.ui.QRViewActivity;
...
//        holder.cmob.setText(mDataset.get(position).getCPhone());
        ...
        holder.odrId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                obj.setSecurityCode(mDataset.get(position).getSecurity_code());
                obj.setQrScanStatus(mDataset.get(position).getScan_flag());

                obj.setPhoto1(mDataset.get(position).getPhoto1());
                obj.setPhoto2(mDataset.get(position).getPhoto2());

                //cntext.startActivity(new Intent(cntext, DetailReqActivity.class));
                cntext.startActivity(new Intent(cntext, QRViewActivity.class));
            }
        });
    }
