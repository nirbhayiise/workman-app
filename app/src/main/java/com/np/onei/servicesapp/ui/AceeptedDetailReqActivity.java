...
public class AceeptedDetailReqActivity extends AppCompatActivity implements AcceptReqInterface , SubmitFaultAnalysisInterface , AddFaultInterface , FaultListInterface , FaultAnalysisItemRemove, PermissionCallBack

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        obj.requestMultiplePermissions(AceeptedDetailReqActivity.this,this);
...
//                TARObj.acceptReq(obj.getReqId(),obj.getTuId());
        ...
        Picasso.with(AceeptedDetailReqActivity.this).load(Const.BASE_URL_IMG+obj.getPhoto1()).into(img1);
        Picasso.with(AceeptedDetailReqActivity.this).load(Const.BASE_URL_IMG+obj.getPhoto2()).into(img2);
    }
