...
$sql="SELECT a.*,b.*,d.*,e.* FROM Enquiry a, professional_area b, services d, customer e WHERE a.cat_id=b.pro_id and a.service_id=d.s_id and a.c_id=e.c_id and a.e_status='1' and a.alloted_technician_id='$tid' and a.work_status=5 ORDER by a.e_id DESC";
