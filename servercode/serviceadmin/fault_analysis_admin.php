                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Fault Analysis</strong>
                            ...
                            <div class="card-body">
                                       ...
                                       <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['f_details']; ?></td>
                                             <td>  <input type="text" placeholder="Enter Amount by Admin" id="amt<?php echo $cat_id; ?>" name="amt<?php echo $cat_id; ?>" value="<?php echo $row['f_amount']; ?>"></td>
                                            
                                          
                                          <td>
                                          	<a class="btn btn-success btn-sm text-light"onClick = "Catactivedeactive('<?php echo $cat_id;?>',0)">Approve</a>
                                          </td>
                                ...
                                <p>Service Charges:</p>
                                <input type="text" placeholder="Enter Service Charges" id="servicecharges" name="servicecharges" value="<?php  echo $charges; ?>">
                               <br>
                                 <p>*Note: After Approve all fault Analysis Amount Please make sure Click On "Done"</p>
                                	<a class="btn btn-success btn-sm text-light"onClick = "TotalAmt('<?php echo $e_id;?>')">Done</a>
                            </div>
                        </div>
                    </div>
                </div>
